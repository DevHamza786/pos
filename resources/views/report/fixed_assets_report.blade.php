@extends('layouts.app')
@section('title', __('Fixed Assets Report'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>{{ __('Fixed Assets Report')}}</h1>
</section>
    ...
    <div class="row no-print">
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => action('ReportController@getAssetsReport'), 'method' => 'get' ]) !!}
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('category_id', __('Fixed Assets').':') !!}
