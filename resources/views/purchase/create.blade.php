		...
		<div class="row">
			<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<select name="contact_id" id="supplier_id" class="form-control">
								<option value=""></option>
							@foreach($contacts as $contact)
								<option value="{{ $contact->id }}" data-contact_id="{{ $contact->contact_id }}" data-pay_term_number="{{ $contact->pay_term_number }}" data-pay_term_type="{{ $contact->pay_term_type }}" data-balance="{{ $contact->balance }}" >{{ $contact->business_name }}</option>
							@endforeach
						</select>
						<!-- {!! Form::select('contact_id', $contacts, null, ['class' => 'form-control', 'placeholder' => __('messages.please_select'), 'required', 'id' => 'supplier_id']); !!} -->
			...
			<div class="col-sm-3">
                <div class="form-group">
                    ...
                    {!! Form::file('document[]', ['id' => 'upload_document', 'multiple' => 'multiple', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
                    <p class="help-block">
